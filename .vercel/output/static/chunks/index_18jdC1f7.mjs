/* empty css                         */
import { a as createAstro, b as createComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent, u as unescapeHTML, F as Fragment, h as renderSlot } from './astro/server_CKhwUAPt.mjs';
import 'kleur/colors';
import { b as $$LightModeBrandLogo, c as $$DarkModeBrandLogo, $ as $$Icon, a as $$MainLayout } from './MainLayout_cTAs6IEz.mjs';
...
const $$HeroSection = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="mt-6 flex max-w-[85rem] flex-col items-center justify-center gap-4 px-4 py-14 sm:px-6 md:flex-row md:items-center md:gap-8 lg:px-8 2xl:max-w-full"> <div> <h1 class="block text-balance text-3xl font-bold tracking-tight text-neutral-800 dark:text-neutral-200 sm:text-4xl lg:text-6xl lg:leading-tight"> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(title)}` })} </h1> ${subTitle && renderTemplate`<p class="mt-3 text-pretty text-lg leading-relaxed text-neutral-700 dark:text-neutral-400 lg:w-4/5">${subTitle}</p>`} <div class="mt-7 grid w-full gap-3 sm:inline-flex"> ${primaryBtn && renderTemplate`${renderComponent($$result, "PrimaryCTA", $$PrimaryCTA, { "title": primaryBtn, "url": primaryBtnURL })}`} ${secondaryBtn && renderTemplate`${renderComponent($$result, "SecondaryCTA", $$SecondaryCTA, { "title": secondaryBtn, "url": secondaryBtnURL })}`} </div> </div> <div class="flex w-full justify-start md:justify-end"> <div class="hidden rounded-lg text-xl font-bold outline-none ring-zinc-500 focus-visible:ring hs-dark-mode-active:hidden dark:flex dark:ring-zinc-200 dark:focus:outline-none"> <!-- {src && alt && <Image src={src} alt={alt} class="h-[300px] w-[450px]" draggable={"false"} loading={"eager"} format={"png"} />} --> ${renderComponent($$result, "LightModeBrandLogo", $$LightModeBrandLogo, { "width": "450", "height": "450" })} </div> <div class="flex rounded-lg text-xl font-bold outline-none ring-zinc-500 focus-visible:ring hs-dark-mode-active:hidden dark:hidden dark:ring-zinc-200 dark:focus:outline-none"> ${renderComponent($$result, "DarkModeBrandLogo", $$DarkModeBrandLogo, { "width": "450", "height": "450" })} </div> </div> </section>`;
...
const $$TabNav = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Tab button with dynamic class based on 'first' property, id, tab data, and aria-controls  -->${maybeRenderHead()}<button type="button"${addAttribute(`${first ? "active " : ""}${BUTTON_CLASS}`, "class")}${addAttribute(id, "id")}${addAttribute(dataTab, "data-hs-tab")}${addAttribute(aria, "aria-controls")} role="tab"> <!-- Slot for additional content --> <span class="flex"> ${renderSlot($$result, $$slots["default"])} <!-- Container for the heading and content of the tab --> <span class="ms-6 grow"> <!-- Heading of the tab, changes color when active --> <span class="block text-lg font-bold text-yellow-500 hs-tab-active:text-yellow-500">${heading}</span> <!-- Content of the tab, changes color when active --> <span class="mt-1 block text-neutral-500 hs-tab-active:text-neutral-600 dark:text-neutral-400 dark:hs-tab-active:text-neutral-200">${content}</span> </span> </span> </button>`;
...
const $$StatsGrid = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<li class="-m-0.5 flex flex-col gap-4 p-4 sm:p-8"> <div class="flex items-center gap-x-2"> <h3 class="flex items-end text-base font-bold text-neutral-800 dark:text-neutral-200 sm:text-3xl"> ${header} </h3> ${renderComponent($$result, "Icon", $$Icon, { "name": headerLowerCase })} </div> <p class="text-sm text-neutral-600 dark:text-neutral-400 sm:text-base"> ${description} </p> </li>`;
...
const heroImage = new Proxy({"src":"/_astro/imagen_llaves.D9k9b_Oq.png","width":259,"height":194,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/imagen_llaves.png");
							return target[name];
						}
					});
...
const calculatingcosts = new Proxy({"src":"/_astro/calculatingcosts.B8bVM3_A.png","width":888,"height":594,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/calculatingcosts.png");
							return target[name];
						}
					});
...
const parejita = new Proxy({"src":"/_astro/parejita.DbwJsrwX.png","width":508,"height":760,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/parejita.png");
							return target[name];
						}
					});
...
const alquilerseguro = new Proxy({"src":"/_astro/alquilerseguro.DVBEvO-7.png","width":450,"height":450,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/alquilerseguro.png");
							return target[name];
						}
					});
