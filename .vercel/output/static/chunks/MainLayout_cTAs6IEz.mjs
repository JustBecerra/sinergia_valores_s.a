import { a as createAstro, b as createComponent, d as renderTemplate, u as unescapeHTML, e as addAttribute, f as renderComponent, F as Fragment, m as maybeRenderHead, g as renderScript, h as renderSlot, i as renderHead } from './astro/server_CKhwUAPt.mjs';
import 'kleur/colors';
import { g as getImage } from './_astro_assets_9esSkFSG.mjs';
import { i as icon } from './icon_Q_PdEYLp.mjs';
import 'clsx';
/* empty css                                   */
...
const ogImageSrc = new Proxy({"src":"/_astro/social.CWnIx2-K.png","width":1200,"height":600,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/social.png");
							return target[name];
						}
					});
...
const faviconSvgSrc = new Proxy({"src":"/_astro/icon.B8WK9w9P.svg","width":512,"height":512,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/icon.svg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/icon.svg");
							return target[name];
						}
					});
...
const $$WhatsAppRedirect = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="group"> <a${addAttribute(whatsappURL, "href")} target="_blank" rel="noopener noreferrer" class="flex cursor-pointer items-center gap-4"> <svg width="40" height="40" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308" class="fill-current text-black ring-zinc-500 group-hover:text-neutral-500 dark:text-neutral-400 dark:ring-zinc-200 dark:focus:outline-none dark:group-hover:text-neutral-500"> <g id="XMLID_468_"> <path id="XMLID_469_" d="M227.904,176.981c-0.6-0.288-23.054-11.345-27.044-12.781c-1.629-0.585-3.374-1.156-5.23-1.156
            ...
            C276.546,215.678,222.799,268.994,156.734,268.994z"></path> </g> </svg> <h3 class="rounded-lg text-base text-sm font-bold font-medium text-black outline-none ring-zinc-500 group-hover:text-neutral-500 dark:text-neutral-400 dark:ring-zinc-200 dark:focus:outline-none dark:group-hover:text-neutral-500 md:py-3 md:text-sm 2xl:text-base"> ${PhoneNumber} </h3> </a> </div>`;
...
const $$FooterSection = createComponent(($$result, $$props, $$slots) => {
  ...
  const sectionThreeTitle = "Contactanos";
  const arrepentimiento = "Arrepentimiento";
  return renderTemplate`${maybeRenderHead()}<footer class="w-full bg-neutral-300 dark:bg-neutral-900"> <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:pt-20 2xl:max-w-screen-2xl"> <div class="grid grid-cols-2 gap-6 md:grid-cols-4"> <div class="col-span-full hidden hs-dark-mode-active:block lg:col-span-1"> ${renderComponent($$result, "LightModeBrandLogo", $$LightModeBrandLogo, {})} </div> <div class="col-span-full hs-dark-mode-active:hidden lg:col-span-1"> ${renderComponent($$result, "DarkModeBrandLogo", $$DarkModeBrandLogo, {})} </div> ${strings.footerLinks.map((section) => renderTemplate`<div class="col-span-1"> <h3 class="font-bold text-neutral-800 dark:text-neutral-200">${section.section}</h3> <ul${addAttribute(`mt-3 flex w-fit ${section.section === "Servicios" && "flex-col"} ${section.section === "Redes Sociales" && "flex-wrap"} gap-4 lg:flex-row`, "class")}> ${section.links.map((link) => renderTemplate`<li> <a${addAttribute(link.url, "href")}${addAttribute(`inline-flex gap-x-2 text-nowrap rounded-lg border-yellow-500 text-neutral-600 outline-none ring-zinc-500 transition duration-300 focus-visible:ring dark:text-neutral-400 dark:ring-zinc-200 dark:hover:text-yellow-400 dark:focus:outline-none`, "class")}> ${section.section === "Servicios" ? link.name : renderTemplate`${renderComponent($$result, "Icon", $$Icon, { "name": link.name })}`} </a> </li>`)} </ul> </div>`)} <div class="col-span-1 hidden justify-between md:flex"> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-bold text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ${sectionThreeTitle} </a> </div> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-bold text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ${arrepentimiento} </a> </div> </div> <!-- <div class="col-span-1 flex justify-between "> --> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-bold text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ${sectionThreeTitle} </a> </div> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-bold text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ${arrepentimiento} </a> </div> <!-- </div> --> </div> <div class="mt-9 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0"> <div class="flex items-center justify-between"> <p class="text-sm text-neutral-600 dark:text-neutral-400">
© <span id="current-year"></span> ${SITE.title}.
</p> </div> </div> ${renderScript($$result, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/sections/FooterSection.astro?astro&type=script&index=0&lang.ts")} </div> </footer>`;
...
export { $$Icon as $, ArrepentimientoFormInfo as A, SITE as S, $$MainLayout as a, $$LightModeBrandLogo as b, $$DarkModeBrandLogo as c };
