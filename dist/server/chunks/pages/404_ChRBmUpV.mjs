...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":["images.unsplash.com"],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/dist/client/");
...
const ogImageSrc = new Proxy({"src":"/_astro/social.CWnIx2-K.png","width":1200,"height":600,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/social.png";
							}
...
const icon = new Proxy({"src":"/_astro/icon.CvGbDubJ.png","width":32,"height":32,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/images/icon.png";
							}
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/Meta.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/ThemeIcon.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/LightModeBrandLogo.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/DarkModeBrandLogo.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/sections/WhatsAppRedirect.astro", void 0);
...
const $$FooterSection = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<footer class="w-full bg-neutral-300 dark:bg-neutral-900"> <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:pt-20 2xl:max-w-screen-2xl"> <div class="grid grid-cols-2 gap-6 md:grid-cols-4"> <div class="col-span-full hidden hs-dark-mode-active:block lg:col-span-1"> ', ' </div> <div class="col-span-full hs-dark-mode-active:hidden lg:col-span-1"> ', " </div> ", ' <div class="col-span-1 hidden justify-between md:flex"> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> </div> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> </div> <div class="mt-9 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0"> <div class="flex items-center justify-between"> <p class="font-nunito text-sm text-neutral-600 dark:text-neutral-400">\n\xA9 <span id="current-year"></span> ', '.\n</p> </div> </div> <!-- Contenedor de la imagen --> <div class="mt-6 flex justify-end"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1134.7167974729828!2d-57.952428592613366!3d-34.910013496124584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a2e637e73ab81b%3A0x9835c71d1ffd0582!2sC.%205%20668%2C%20La%20Plata%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1722559777561!5m2!1ses-419!2sar" class="h-24" width="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> <a href="http://qr.afip.gob.ar/?qr=Goz8RzK5XRZ32i-lGg5AvQ,," target="_F960AFIPInfo"> <img src="http://www.afip.gob.ar/images/f960/DATAWEB.jpg" class="w-16 h-24"> </a> </div> ', ' </div> </footer> <!-- ---\nimport enStrings from "@utils/navigation.ts";\nimport { SITE } from "@data/constants";\nimport LightModeBrandLogo from "@/components/LightModeBrandLogo.astro";\nimport DarkModeBrandLogo from "../DarkModeBrandLogo.astro";\nimport { FaInstagram, FaTiktok, FaFacebook } from "react-icons/fa";\n\nimport { FaXTwitter } from "react-icons/fa6";\n\n\n\nconst strings = enStrings;\nconst sectionThreeTitle: string = "Cont\xE1ctanos";\nconst arrepentimiento: string = "Arrepentimiento";\n---\n\n<footer class="w-full bg-neutral-300 dark:bg-neutral-900">\n  <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:pt-20 2xl:max-w-screen-2xl">\n    <div class="grid grid-cols-2 gap-6 md:grid-cols-4">\n      <div class="col-span-full hidden hs-dark-mode-active:block lg:col-span-1">\n        <LightModeBrandLogo />\n      </div>\n      <div class="col-span-full hs-dark-mode-active:hidden lg:col-span-1">\n        <DarkModeBrandLogo />\n      </div>\n      {strings.footerLinks.map((section) => (\n        <div class="col-span-1">\n          <h3 class="font-gotham text-neutral-800 dark:text-neutral-200">{section.section}</h3>\n          <ul\n            class={`mt-3 flex w-fit ${section.section === "Servicios" && "flex-col"} ${section.section === "Redes Sociales" && "flex-wrap"} gap-4 lg:flex-row`}\n          >\n            {section.links.map((link) => (\n              <li>\n                <a\n                  href={link.url}\n                  class={`inline-flex gap-x-2 text-nowrap rounded-lg border-yellow-500 font-nunito text-neutral-600 outline-none ring-zinc-500 transition duration-300 focus-visible:ring dark:text-neutral-400 dark:ring-zinc-200 dark:hover:text-yellow-400 dark:focus:outline-none`}\n                >\n                  {section.section === "Servicios"\n                    ? link.name\n                    : link.name === "Instagram"\n                    ? <FaInstagram />\n                    : link.name === "Tiktok"\n                    ? <FaTiktok />\n                    : link.name === "Facebook"\n                    ? <FaFacebook />\n                    : link.name === "Twitter"\n                    ? <FaXTwitter />\n                    : link.name}\n                </a>\n              </li>\n            ))}\n          </ul>\n        </div>\n      ))}\n      <div class="col-span-1 hidden justify-between md:flex">\n        <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto">\n          <a\n            href="/contacto"\n            class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n          >\n            {sectionThreeTitle}\n          </a>\n        </div>\n\n        <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto">\n          <a\n            href="/arrepentimiento"\n            class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n          >\n            {arrepentimiento}\n          </a>\n        </div>\n      </div>\n\n      <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto">\n        <a\n          href="/contacto"\n          class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n        >\n          {sectionThreeTitle}\n        </a>\n      </div>\n\n      <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto">\n        <a\n          href="/arrepentimiento"\n          class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n        >\n          {arrepentimiento}\n        </a>\n      </div>\n    </div>\n\n    <div class="mt-9 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0">\n      <div class="flex items-center justify-between">\n        <p class="font-nunito text-sm text-neutral-600 dark:text-neutral-400">\n          \xA9 <span id="current-year"></span> {SITE.title}.\n        </p>\n      </div>\n    </div>\n\n    <script>\n      const year = new Date().getFullYear();\n      const element = document.getElementById("current-year");\n      element!.innerText = year.toString();\n    <\/script>\n  </div>\n</footer> -->'], ["", '<footer class="w-full bg-neutral-300 dark:bg-neutral-900"> <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:pt-20 2xl:max-w-screen-2xl"> <div class="grid grid-cols-2 gap-6 md:grid-cols-4"> <div class="col-span-full hidden hs-dark-mode-active:block lg:col-span-1"> ', ' </div> <div class="col-span-full hs-dark-mode-active:hidden lg:col-span-1"> ', " </div> ", ' <div class="col-span-1 hidden justify-between md:flex"> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> </div> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/contacto" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto"> <a href="/arrepentimiento" class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"> ', ' </a> </div> </div> <div class="mt-9 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0"> <div class="flex items-center justify-between"> <p class="font-nunito text-sm text-neutral-600 dark:text-neutral-400">\n\xA9 <span id="current-year"></span> ', '.\n</p> </div> </div> <!-- Contenedor de la imagen --> <div class="mt-6 flex justify-end"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1134.7167974729828!2d-57.952428592613366!3d-34.910013496124584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a2e637e73ab81b%3A0x9835c71d1ffd0582!2sC.%205%20668%2C%20La%20Plata%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1722559777561!5m2!1ses-419!2sar" class="h-24" width="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> <a href="http://qr.afip.gob.ar/?qr=Goz8RzK5XRZ32i-lGg5AvQ,," target="_F960AFIPInfo"> <img src="http://www.afip.gob.ar/images/f960/DATAWEB.jpg" class="w-16 h-24"> </a> </div> ', ' </div> </footer> <!-- ---\nimport enStrings from "@utils/navigation.ts";\nimport { SITE } from "@data/constants";\nimport LightModeBrandLogo from "@/components/LightModeBrandLogo.astro";\nimport DarkModeBrandLogo from "../DarkModeBrandLogo.astro";\nimport { FaInstagram, FaTiktok, FaFacebook } from "react-icons/fa";\n\nimport { FaXTwitter } from "react-icons/fa6";\n\n\n\nconst strings = enStrings;\nconst sectionThreeTitle: string = "Cont\xE1ctanos";\nconst arrepentimiento: string = "Arrepentimiento";\n---\n\n<footer class="w-full bg-neutral-300 dark:bg-neutral-900">\n  <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:pt-20 2xl:max-w-screen-2xl">\n    <div class="grid grid-cols-2 gap-6 md:grid-cols-4">\n      <div class="col-span-full hidden hs-dark-mode-active:block lg:col-span-1">\n        <LightModeBrandLogo />\n      </div>\n      <div class="col-span-full hs-dark-mode-active:hidden lg:col-span-1">\n        <DarkModeBrandLogo />\n      </div>\n      {strings.footerLinks.map((section) => (\n        <div class="col-span-1">\n          <h3 class="font-gotham text-neutral-800 dark:text-neutral-200">{section.section}</h3>\n          <ul\n            class={\\`mt-3 flex w-fit \\${section.section === "Servicios" && "flex-col"} \\${section.section === "Redes Sociales" && "flex-wrap"} gap-4 lg:flex-row\\`}\n          >\n            {section.links.map((link) => (\n              <li>\n                <a\n                  href={link.url}\n                  class={\\`inline-flex gap-x-2 text-nowrap rounded-lg border-yellow-500 font-nunito text-neutral-600 outline-none ring-zinc-500 transition duration-300 focus-visible:ring dark:text-neutral-400 dark:ring-zinc-200 dark:hover:text-yellow-400 dark:focus:outline-none\\`}\n                >\n                  {section.section === "Servicios"\n                    ? link.name\n                    : link.name === "Instagram"\n                    ? <FaInstagram />\n                    : link.name === "Tiktok"\n                    ? <FaTiktok />\n                    : link.name === "Facebook"\n                    ? <FaFacebook />\n                    : link.name === "Twitter"\n                    ? <FaXTwitter />\n                    : link.name}\n                </a>\n              </li>\n            ))}\n          </ul>\n        </div>\n      ))}\n      <div class="col-span-1 hidden justify-between md:flex">\n        <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto">\n          <a\n            href="/contacto"\n            class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n          >\n            {sectionThreeTitle}\n          </a>\n        </div>\n\n        <div class="flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto xl:mx-auto">\n          <a\n            href="/arrepentimiento"\n            class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-500 hover:text-yellow-500 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n          >\n            {arrepentimiento}\n          </a>\n        </div>\n      </div>\n\n      <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto">\n        <a\n          href="/contacto"\n          class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n        >\n          {sectionThreeTitle}\n        </a>\n      </div>\n\n      <div class="col-span-1 flex h-fit w-fit items-center justify-center rounded-2xl bg-white p-2 dark:bg-black md:ml-auto md:hidden xl:mx-auto">\n        <a\n          href="/arrepentimiento"\n          class="cursor-pointer rounded-lg border-2 border-black p-2 font-gotham text-neutral-800 hover:border-yellow-50 hover:text-yellow-50 dark:border-white dark:text-neutral-200 dark:hover:border-yellow-400 dark:hover:text-yellow-400"\n        >\n          {arrepentimiento}\n        </a>\n      </div>\n    </div>\n\n    <div class="mt-9 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0">\n      <div class="flex items-center justify-between">\n        <p class="font-nunito text-sm text-neutral-600 dark:text-neutral-400">\n          \xA9 <span id="current-year"></span> {SITE.title}.\n        </p>\n      </div>\n    </div>\n\n    <script>\n      const year = new Date().getFullYear();\n      const element = document.getElementById("current-year");\n      element!.innerText = year.toString();\n    <\/script>\n  </div>\n</footer> -->'])), maybeRenderHead(), renderComponent($$result, "LightModeBrandLogo", $$LightModeBrandLogo, {}), renderComponent($$result, "DarkModeBrandLogo", $$DarkModeBrandLogo, {}), strings.footerLinks.map((section) => renderTemplate`<div class="col-span-1"> <h3 class="font-gotham text-neutral-800 dark:text-neutral-200">${section.section}</h3> <ul${addAttribute(`mt-3 flex w-fit ${section.section === "Servicios" && "flex-col"} ${section.section === "Redes Sociales" && "flex-wrap"} gap-4 lg:flex-row`, "class")}> ${section.links.map((link) => renderTemplate`<li> <a${addAttribute(link.url, "href")}${addAttribute(`inline-flex gap-x-2 text-nowrap rounded-lg border-yellow-500 font-nunito text-neutral-600 outline-none ring-zinc-500 transition duration-300 focus-visible:ring dark:text-neutral-400 dark:ring-zinc-200 dark:hover:text-yellow-400 dark:focus:outline-none`, "class")}> ${section.section === "Servicios" ? link.name : link.name === "Instagram" ? renderTemplate`${renderComponent($$result, "FaInstagram", FaInstagram, {})}` : link.name === "Tiktok" ? renderTemplate`${renderComponent($$result, "FaTiktok", FaTiktok, {})}` : link.name === "Facebook" ? renderTemplate`${renderComponent($$result, "FaFacebook", FaFacebook, {})}` : link.name === "Twitter" ? renderTemplate`${renderComponent($$result, "FaXTwitter", FaXTwitter, {})}` : link.name} </a> </li>`)} </ul> </div>`), sectionThreeTitle, arrepentimiento, sectionThreeTitle, arrepentimiento, SITE.title, renderScript($$result, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/sections/FooterSection.astro?astro&type=script&index=0&lang.ts"));
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/sections/FooterSection.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/layouts/MainLayout.astro", void 0);
...
}, "C:/Users/NICO/Desktop/Diegote/sinergia_valores_s.a/src/components/ui/icons/Icon.astro", void 0);
